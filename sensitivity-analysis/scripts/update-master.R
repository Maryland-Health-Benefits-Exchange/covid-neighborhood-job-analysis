...
setwd("C:/Documents/sensitivity-analysis")
...
# source("scripts\\update\\3-produce-data-files-update.R", encoding = "UTF-8") # verified, do not need
# source("scripts\\update\\4-produce-summary-stats-update.R", encoding = "UTF-8") # verified, do not need
...
ipums_data_merge <- readRDS(file = "data/processed-data/ipums-data-merge-sensitivity-analysis.Rds")
setwd("C:/Documents/COVID19_Uninsured_Analysis")
saveRDS(ipums_data_merge, file = "data/processed/ipums-data-merge-sensitivity-analysis.Rds")
